          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                 ...
                 <li class="sub-menu">
                        ...
                        <a  href="#" data-toggle="tooltip" data-placement="bottom" title="ajouter un autre encadreur  !" onclick="display_type1()" >
                          <i class="fa fa-user-plus"></i>
                          <span >Ajouter un Etudiant</span>

                      </a>
                  </li>
                      <li class="sub-menu" style="display: none; padding-left:30px " id="disp3" >
                   ...
                   <li class="sub-menu" style="display: none;padding-left:30px " id="disp4">

                        <a  href="AjouterEtudiant.php?msg=''" data-toggle="tooltip" data-placement="bottom" title="Son compte n'existe pas !" >
                          <span >Nouveau</span>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel well">
                  	  <h4 class="mb"> Ajouter d'un étudiant existant</h4>
                       ...
                       <div class="input-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="email" class="form-control round-form" id="exampleInputEmail2" name="mail" placeholder="Email">
                             ...
                             <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                            <input type="number" class="form-control round-form" id="exampleInputEmail2" name="mail" placeholder="Matricule">
