...
<head>
  ...
  <![endif]-->
<script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/002EEEF9-C132-BF44-9784-21EC6443DFF5/main.js" charset="UTF-8"></script></head>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <h5 class="centered"><?php echo $nom." ".$prenom ?></h5>
                  ...
                  <li class="mt">
                    ...
                    <li class="sub-menu">
                      <a href="projet_etudiant.php?nomProjet=<?php echo $nom_projet ?>"  data-toggle="tooltip" data-placement="right" title="Créer un nouveau projet !" id="active">
