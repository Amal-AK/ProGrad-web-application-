...
if ($type_user=='etudiant')
{
  ...
  $type="ETUD";
  $req = $bdd->prepare('SELECT chemin  FROM photos WHERE  id_user = :id && type_user = :type ');
  $req->execute(array(
      'id' => $id,
      'type' => $type
...
?>
  ...
  <div class="col-md-12 intro">
    <div class="col-md-6 ">
          ...
          <?php if ($type_user=='etudiant' & $_SESSION['type_user']!='etudiant') {

						  ?>


						<button class="btn btn-primary button " style="font-size: 14px"> <a href="Supp_etud.php?id=<?php echo $id ?>&nom=<?php echo $resultat['nom']." ". $resultat['prenom'];?>"  >Retirer du projet</a> </button>
        ...
        <div class="row">
                    <div class="col-md-12">
                        <div class="content-panel" style="margin:5px 20px 20px 20px ">
                            <hr>
                          <table class="table table-striped" style="color : rgba(70, 79, 88, 1) ; " >
                              <thead>
                              <tr>
